...
/**
 * Test cases for {@link SmlMeterHandler}. The tests provide mocks for supporting entities using Mockito.
 *
 * @author Jens Pfaffmann - Initial contribution
 */
public class SmlMeterHandlerTest extends JavaTest {
    ...
    public void setUp() {
        initMocks(this);
        handler = new SmlMeterHandler(thing);
